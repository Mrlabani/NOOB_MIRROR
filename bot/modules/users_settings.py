...
Examples:
1. <code>{escape('<b>Join: @L_Abani</b>')}</code> 
This will give output as:
<b>Join: @L_Abani</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @L_Abani</code>')}</code> 
This will give output as:
<code>Join: @L_Abani</code> <code>69MB.bin</code>.
